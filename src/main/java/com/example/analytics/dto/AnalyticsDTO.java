...
public class AnalyticsDTO {
    ...
    public AnalyticsDTO(long totalTasks, double completionRate, Map<String, Long> categoryDistribution, Map<String, Long> statusDistribution, Map<String, Long> priorityDistribution) {
